(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        jsonDataCars.forEach((function(item) {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        var jsonDataTrailers = [ {
            cargoTrailerId: 1,
            trailerNumber: "DFT 34"
        }, {
            cargoTrailerId: 2,
            trailerNumber: "DFG 345"
        }, {
            cargoTrailerId: 3,
            trailerNumber: "GFH 563"
        }, {
            cargoTrailerId: 4,
            trailerNumber: "QWE 111"
        }, {
            cargoTrailerId: 5,
            trailerNumber: "RET 222"
        }, {
            cargoTrailerId: 6,
            trailerNumber: "FGH 333"
        }, {
            cargoTrailerId: 7,
            trailerNumber: "DSF 444"
        }, {
            cargoTrailerId: 8,
            trailerNumber: "GFD 555"
        } ];
        var select = document.getElementById("trailerNumber");
        jsonDataTrailers.forEach((function(item) {
            var option = document.createElement("option");
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        var jsonDataList = [ {
            trackPairId: 1,
            headNumber: "WR 65434",
            trailerNumber: "DSF 111",
            date: "2024-07-17",
            fromCountry: "POLSHA",
            toCountry: "BREST",
            cargo: "oranges",
            comment: "Vilila za rulem"
        }, {
            trackPairId: 1,
            headNumber: "WR 65434",
            trailerNumber: "DSF 111",
            ...
            toCountry: "BREST",
            cargo: "oranges",
            comment: "Vilila za rulemVilila za rulemVilila za rulemVilila za rulemVilila za rulemVilila za rulemVilila za rulemVilila za rulemVilila za rulemVilila za rulemVilila za rulemVilila za rulem"
        }, {
            trackPairId: 1,
            headNumber: "WR 65434",
            trailerNumber: "DSF 111",
            ...
            trackPairId: 2,
            headNumber: "WW 34214",
            trailerNumber: "DSF 222",
            date: "2024-07-17",
            fromCountry: "CHICAGO",
            toCountry: "NEW YORK",
            cargo: "coconuts",
            comment: "EDU ZA FRUKTAMI"
        }, {
            trackPairId: 3,
            headNumber: "SS 45211",
            trailerNumber: "DSF 444",
        ...
        jsonDataList.forEach((function(item) {
